$(document).ready(function() {
    var sds = document.getElementById("prod_dum");
    if(sds == null){
        $("#prod_selection").hide();
    }
    var sdss = document.getElementById("prod_dumdiv");
    if(sdss == null){
        $("#prod_selection").hide();
    }
})
...
$(function() {
  ...
  $('#prod_listBox').html(options);
});
function selct_prod_district($val)
{
    if($val=='SELECT STATE') {
   var options = '';
  $('#prod_secondlist').html(options);
  }
